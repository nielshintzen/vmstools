...
nestedGrid(
  ...
  maxstep = 10,
  n = 20,
  control = list(clm = NULL, FUN = NULL)
)
}
\arguments{
...
\item{maxstep}{The maxiumum number of times the grid cells should be split}

\item{n}{If the number of points in a cell \code{>= n} then split the cell}

\item{control}{A list determining the output in the \code{data} slot, the
...
\value{
A SpatialPolygonsDataFrame, the value of the \code{data} slot will
...
\references{
Gerritsen, H. D., Minto, C. and Lordan, C. (2013) How much of
