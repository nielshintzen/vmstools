...
% Please edit documentation in R/interpolateTacsat.r
...
\item{margin}{Deviation from specified interval to find succeeding
datapoints}

\item{res}{Number of points to use to create interpolation (including start
and end point), default = 100}

\item{method}{"cHs" for cubic Hermite spline or "SL" for Straight Line
interpolation, default = 0.2,20,0.2}

\item{params}{Params needed for cHs method, including the speed thresholds
used}

\item{headingAdjustment}{Parameter to adjust the choice of heading depending
on its own or previous point}

\item{fast}{If your machine holds enough RAM (4gig or more) than the fast
...
\references{
Hintzen et al. 2010 Improved estimation of trawling tracks using
cubic Hermite spline interpolation of position registration data, EU lot 2
project
}
\seealso{
\code{\link{findEndTacsat}}, \code{\link{distance}},
