...
% Please edit documentation in R/calculateCI.R
\name{calculateCI}
\alias{calculateCI}
\title{Calculate the CI between two succeeding VMS datapoints}
\usage{
calculateCI(int, tacint, params, grid, spatialGrid, plot = FALSE)
}
\arguments{
...
\value{
Returns the Confidence Interval on a grid of class
...
\note{
Computation can take a very long time if either grid resolution is
...
\seealso{
\code{\link{interpolateTacsat}},\code{\link{maxRangeCI}}
}
\author{
Niels T. Hintzen
}
