...
% Please edit documentation in R/findEndTacsat.r
\name{findEndTacsat}
\alias{findEndTacsat}
\title{Finding the succeeding Tacsat datapoint based on an interval with a
specified margin}
\usage{
findEndTacsat(SI_DATIM, startVMS, interval, margin)
}
\arguments{
...
\seealso{
\code{\link{filterTacsat}}, \code{\link{interpolateTacsat}}
}
\author{
Niels T. Hintzen
}
