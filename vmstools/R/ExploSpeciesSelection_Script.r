...
print("selection of possible residual species... (please be patient!!)")        
    ...
    explo_species <- list(nbMainSpeciesHAC=nbMainSpeciesHAC, nbMainSpeciesTotale=nbMainSpeciesTotale, nbMainSpeciesLogevent=nbMainSpeciesLogevent,
    NamesMainSpeciesHAC=sort(NamesMainSpeciesHAC), NamesMainSpeciesTotaleUnsorted=sort(NamesMainSpeciesTotale), 
    NamesMainSpeciesTotaleSorted=NamesMainSpeciesTotale,NamesMainSpeciesLogevent=sort(NamesMainSpeciesLogevent),
