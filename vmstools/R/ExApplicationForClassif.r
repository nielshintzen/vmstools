...
param3="euclidean"
param4=NULL
cahacpclara=classif(dat,methSpecies,param1,param2,pcaYesNo,methMetier,param3,param4)
...
dat=OTB2008euroNS 
classif_OTB2008euroNS=classif(dat,"hac","euclidean","ward","pca","clara","euclidean",NULL)
