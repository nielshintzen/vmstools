...
for(a.year in as.character(2005:2009)){
  ...
  pings2LandingsMaps(all.merged=all.merged, sp="LE_EURO_COD",
    ...
    breaks0= c(0,100, 100*(2^1),100*(2^2),100*(2^3),100*(2^4),100*(2^5),
    100*(2^6), 100*(2^7),100*(2^8),100*(2^9), 10000000))
}

# create some animations...
# (need the 'animation' R package and ImageMagik installed)
mapsLandings2GIFanim(idir = file.path("C:","VMSanalysis","FemernBelt",
