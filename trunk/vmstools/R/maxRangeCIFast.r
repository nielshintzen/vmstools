maxRangeCIFast <- function(x,y,time.,speed){
                    ...
                    if(d == 0){
                      o <- 0
                        ...
                        angles  <- (o*(180/pi) + 360) %% 360

                        angle2  <- ifelse(angles>=0 & angles < 90,angle2 <- 90-angles,
                                          ifelse(angles >=90  & angles < 180,angle2 <- angles - 90,
                                                 ifelse(angles >=180 & angles < 270,angle2 <- 90 - (angles-180),angle2 <- (angles - 270))))
